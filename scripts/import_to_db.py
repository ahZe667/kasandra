...
WATCHLIST = [
    dict(
        ...
        slug="zabka",
        crbr_exempt=False,
        notes="duży retail, dużo zmian operacyjnych",
    ),
    dict(
        krs="0000140428",
        nip="8421622720",
        ...
        slug="drutex",
        crbr_exempt=False,
        notes="producent okien/drzwi, stabilna",
    ),
    dict(
        krs="0000898248",
        nip="5512617657",
    ...
    dict(
        ...
        slug="fame_mma",
        crbr_exempt=False,
        notes="młoda SA, dynamiczne zmiany",
    ),
    dict(
        krs="0001008036",
        nip="5273032556",
        ...
        slug="mentzen",
        crbr_exempt=False,
        notes="nowa SA, Mentzen — ciekawy CRBR",
    ),
    dict(
        krs="0000055656",
        nip="5862021333",
        ...
        slug="strong_man",
        crbr_exempt=False,
        notes="stara spółka, logistyka Malbork",
    ),
    dict(
        krs="0000864032",
        nip="9462683417",
        ...
        slug="tenczynek",
        crbr_exempt=False,
        notes="Palikot, strata, ciekawy profil ryzyka",
    ),
    dict(
        krs="0000779880",
        nip="5272889007",
        ...
        slug="januszex",
        crbr_exempt=False,
        notes="mała spółka, 100% właściciel = prezes",
    ),
]
...
def import_crbr_snapshots(conn, normalized_dir: Path, collected_at: str) -> int:
    ...
    for json_path in sorted(crbr_dir.glob("*.json")):
        ...
        print(
            f"  CRBR {collected_at}: {json_path.name} [{status}, {ben} ben.] -> snapshot #{snap_id}"
        )
...
def main() -> None:
    ...
    by_source = conn.execute(
        "SELECT source, status, COUNT(*) as n FROM snapshots"
